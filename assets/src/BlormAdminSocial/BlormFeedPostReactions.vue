<template>
    <div class="BlormFeedPostReactions" :data-activityid="post.activityId" :data-objecttype="post.object.type">
            <el-tabs v-model="activeName" @tab-click="handleClick">
              <el-tab-pane v-if="!isShareOrReblog" name="comments">
                <template #label>
...
<script>
    ...
    export default {
        ...
        mounted: function () {
          if (this.post.object.verb === "share" || this.post.object.verb === "reblog") {
            this.activeName = "reblogs";
          } else {
            this.activeName = "comments";
          }
        },
        computed: {
            isShareOrReblog: function() {
              return (this.post.object.verb === "share" || this.post.object.verb === "reblog")
            },
            // comments
        ...
        methods: {
            ...
            handleClick(tab, event) {
              this.$root.logMsgToCons("BlormFeedPostReaction tab:", tab);
              this.$root.logMsgToCons("BlormFeedPostReaction event:", event);
            },
        },
    }
</script>